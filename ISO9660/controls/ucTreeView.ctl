...
Private Sub UserControl_Terminate()
    ...
    If (m_hTreeView) Then
        ...
        Call modIOIPAOTreeView.TerminateIPAO(m_uIPAO)
        Call pvDestroyFont
...
Public Function Initialize() As Boolean
    ...
    If (m_bInitialized = False) Then
        ...
        If (m_hTreeView) Then
            ...
            Call modIOIPAOTreeView.InitIPAO(m_uIPAO, Me)
...
Public Function SetNodeKey(ByVal hNode As Long, ByVal strNewKey As String) As Boolean
    If IsValidKey(strNewKey) Then
        m_uNodeData(pvTVGetlParam(hNode)).sKey = strNewKey
        SetNodeKey = True
    End If
End Function
